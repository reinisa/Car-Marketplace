...
function FinancialCalculator({carDetail}) {
  ...
  return (
    <div className='p-10 border rounded-xl shadow-md mt-7'>
        <h2 className='font-medium text-2xl text-left'>Financial Calculator</h2>
        ...
        {monthlyPayment>0&& <h2 className='font-medium text-xl mt-5 text-left'>Your Monthly Payment Is : 
            <span className='text-2xl font-bold'>{monthlyPayment}</span></h2>}
